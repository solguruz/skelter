        ...
        onPressed: () {
          if (!isLoading) {
            AnalyticsHelper().logCustomEvent(
              DebugSignUpAnalyticsEvents.kTapEditSignupProfilePicture,
            );
            AddSkipPictureCTA.showImageSourceBottomSheet(
              context,
              ...
              onImageRemoved: () {
                AnalyticsHelper().logCustomEvent(
                  DebugSignUpAnalyticsEvents.kTapSignupProfilePictureRemoved,
                );
