...
import 'package:flutter_skeleton/presentation/login_signup/signup/pages/phone_num_verified_page/widgets/next_cta.dart';
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) {
          AnalyticsHelper().logCustomEvent(
            DebugSignUpAnalyticsEvents.kPhoneVerifiedPageOnBackPressed,
          );
        }
      },
      child: SafeArea(
