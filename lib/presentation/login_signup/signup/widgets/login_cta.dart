    ...
    return Padding(
      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          children: [
            TextSpan(
              text: context.l10n.login_signup_signup_already_have_account,
            ),
            TextSpan(
              text: context.l10n.login_signup_login,
              style:
                  AppTextStyles.p2Bold.withColor(AppColors.textBrandSecondary),
              recognizer: TapGestureRecognizer()
                ..onTap = () async {
                  AnalyticsHelper().logCustomEvent(
                    DebugSignUpAnalyticsEvents.kTapLoginCTAInSignup,
                  );
                  context.loginBloc.add(EnableSignupModeEvent(isSignup: false));
