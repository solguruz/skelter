...
class PhoneNumberOTPPage extends StatefulWidget {
  ...
  @override
  PhoneNumberOTPPageState createState() => PhoneNumberOTPPageState();
}
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocProvider<LoginBloc>.value(
            ...
            child: const _PhoneNumberOTPPageBody(),
          ),
        ),
      ),
    );
...
class _PhoneNumberOTPPageBody extends StatelessWidget {
  const _PhoneNumberOTPPageBody();
