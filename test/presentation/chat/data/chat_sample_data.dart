...
List<ChatModel> generateSampleUsersChat() {
  final List<Map<String, dynamic>> userData = [
    {
      ...
      'last_message_time': DateTime(2025, 1, 1, 10).toIso8601String(),
    ...
    },
    {
      ...
      'last_message_attachment_url': '',
      'last_message_time': DateTime(2025, 1, 1, 9, 30).toIso8601String(),
    ...
    },
    {
      ...
      'last_message_time': DateTime(2025, 1, 1, 9, 15).toIso8601String(),
    ...
    },
    {
      ...
      'last_message_attachment_url': '',
      'last_message_time': DateTime(2025).toIso8601String(),
      'unread_message_count': 0,
      'is_online': false,
      'isTeam': false,
    },
  ...
  for (int i = userData.length; i < 20; i++) {
    userData.add({
      ...
      'last_message_time': DateTime(2025, 1, 1, 8).toIso8601String(),
